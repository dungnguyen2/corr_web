...
def Shearstress(v_sg, v_sl , mass_g, mass_l, vol_g, vol_l, holdup, vis_g, vis_l, roughness, diameter, density_g, density_l):
...
def Cal_Norsok(CO2fraction, Pressure, Temp, v_sg, v_sl , mass_g, mass_l,vol_g,vol_l,holdup,vis_g,vis_l,roughness,diameter, fPH_In,\
                IBicarb, IIonicStrength, CalcOfpH, density_g, density_l):
    CO2Fugacity= FugacityofCO2(CO2fraction, Pressure, Temp)
    ShearStress=Shearstress(v_sg, v_sl , mass_g, mass_l,vol_g,vol_l,holdup,vis_g,vis_l,roughness,diameter, density_g, density_l)
    if ShearStress > 115: ShearStress = 115
